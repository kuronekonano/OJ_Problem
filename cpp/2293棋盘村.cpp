...
int main() {
    ...
    while ( t-- ) {
        ...
        {
            if ( ( i == x && j == y ) || ( i == x + 1 && j == y + 2 ) || ( i == x + 2 && j == y + 1 ) || ( i == x + 1 && j == y - 2 ) || ( i == x + 2 && j == y - 1 ) || ( i == x - 1 && j == y - 2 )
                 || ( i == x - 1 && j == y + 2 ) || ( i == x - 2 && j == y + 1 ) || ( i == x - 2 && j == y - 1 ) ) {
                break;
            }
            else {
                a[ i ][ j ] = 1;
        ...
        for ( i = 0; i <= n; i++ )  // 计算列阵
        {
            ...
            {
                if ( ( i == x && j == y ) || ( i == x + 1 && j == y + 2 ) || ( i == x + 2 && j == y + 1 ) || ( i == x + 1 && j == y - 2 ) || ( i == x + 2 && j == y - 1 )
