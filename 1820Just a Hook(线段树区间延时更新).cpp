...
//    }
//    int mid=(a[root].l+a[root].r)/2;///查找的是当前节点的中点，而不是目的区间的中点
//    if(l>mid)
//    {
...
//        return (a[root].r-a[root].l+1)*a[root].n;///利用mark 数组，已经对应区间的距离求和
//    }///找同样区间的区域块，省时
//    return query(root*2)+query(root*2+1);///左右两棵树作为杂色的两部分继续查找同色区间
//
//}
//int main()
//{
